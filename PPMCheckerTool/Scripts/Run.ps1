...
process
{
    ...
    Write-Output "Checking if power scheme is Balanced...`n"

    
    cmd /c "powercfg /getactivescheme" | Tee-Object -Variable CurrentScheme


    if( $CurrentScheme -like "*381b4222-f694-41f0-9685-ff5bb260df2e*"){
        Write-Output "Scheme is Balanced. Continuing script...`n"
        ...
        Write-Output "ERROR: Scheme is not balanced! Please change the scheme and re-run script`n"
    }
}